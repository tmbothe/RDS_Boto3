class DynamoDB:
    ...
    def create_table(self, table, attribute_definition, key_schema, iops):
        print('Creating table on Dynamodb')
    ...
    def describe_table(self, table):
        print(f'Describing dynamodb table {table}')
    ...
    def update_read_write_capacity(self, table_name, new_read_capacity, new_write_capacity):
        print(f'updaing provisioned table throupput {table_name}')
    ...
    def delete_table_with_name(self, table_name):
        ...
        return self._client.delete_table(
            TableName=table_name
        )
